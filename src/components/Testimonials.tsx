...
function TestimonialCard({ t, i, style = {}, lifted = false }: any) {
  return (
    <article
      className="w-[85vw] md:w-[340px] rounded-2xl p-8 shrink-0 snap-center"
      style={{
        ...
        boxShadow: lifted
          ? "0 30px 80px -20px rgba(0,229,192,0.25), 0 20px 60px -20px rgba(0,0,0,0.8)"
    ...
    <section id="testimonials" style={{ padding: '80px 0', background: '#000000' }}>
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <div className="text-center mb-16 reveal">
          ...
          >
            A hand of{' '}
            <span style={{ color: '#00E5C0' }}>kind words.</span>
          </h2>
        </div>
